        ...
        <div>
          <div className='flex flex-col justify-center py-16 md:py-16 md:flex md:flex-row items-center md:justify-start gap-16'>
            ...
            <div className='flex items-center gap-4 md:gap-8'>
              ...
              <a className='flex items-center gap-2' href='https://www.linkedin.com/in/gutodiasdev/' target='_blank' rel='noreferrer'><RiInstagramLine size='1.5rem' />
                LinkedIn
              </a>
            </div>
          </div>
          <button className='bg-purple-700 py-4 px-8 rounded-full text-white flex gap-2 items-center'>
            Veja meu portfolio
            <i>
              <FaAngleRight />
            </i>
